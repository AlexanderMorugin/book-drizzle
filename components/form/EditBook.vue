  ...
  <form class="form-auth" @submit.prevent="submitAddBook">
    ...
    <ClientOnly>
      <div v-if="!imageUrlField" class="bookUploadImageBlock">
        ...
        >
          <img
            v-if="bookStore.book.image"
            :src="bookStore.book.image"
            :alt="bookStore.book.name"
            :class="[
              'bookUploadImageBlock__background bookUploadImageBlock__background_image',
              { bookUploadImageBlock__background_isDragging: isDragging },
            ]"
          />
          <div
...
const bookNameField = ref(bookStore.book.name);
const authorField = ref(bookStore.book.author);
