  ...
  <div class="infoBlock">
    ...
    <section>
      ...
      <div class="infoBlock__textBlock infoBlock__text">
        ...
        <div>-</div>
        <p>
          На странице "Моя библиотека" сделан поиск по названию книги или
          автору, а также фильтры по статусу прочтения книг. Поиск и фильтрация
          происходит на стороне бекенда.
        </p>
      </div>
    </section>
